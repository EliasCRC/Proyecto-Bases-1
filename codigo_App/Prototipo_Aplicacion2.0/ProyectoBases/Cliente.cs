...
namespace ProyectoBases
{
    class Cliente
    {
        ...
        public SqlDataReader obtenerHorariosFrec(string telefono)
        {
            ...
            try
            {
                datos = bd.ejecutarConsulta("Exec verHorarios " + telefono + ", '" + hoy.ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ssZ") + "'");
            }
            catch (SqlException)
            {
        ...
        {
            DateTime hoy = DateTime.Today.ToUniversalTime();
            Console.WriteLine("Exec eliminarHorarioFrec " + dia + ", " + hora +
                ", '" + hoy.ToString() + "', " + telefono);
            return bd.actualizarDatos("Exec eliminarHorarioFrec " + dia + ", " + hora +
                ", '" + hoy.ToString("yyyy-MM-ddTHH:mm:ssZ") + "', " + telefono);
        }
